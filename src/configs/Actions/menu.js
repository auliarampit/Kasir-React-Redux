...
export const getMenu = (search='',page=1,sort='',category='') => {
    return {
        type: 'GET_MENU',
        payload: axios.get(`http://192.168.43.86:2020/menu?search=${search}&page=${page}&sort=${sort}&category=${category}`)
    }
}
...
export const getSearchMenu = (search='',page=1,sort='') => {
    return {
        type: 'GET_SEARCH',
        payload: axios.get(`http://192.168.43.86:2020/menu?search=${search}&page=${page}&sort=${sort}`)
...
//     return {
//         type: "ADD_MENU",
//         payload: axios.post(`http://192.168.6.103:2020/menu`, data)
//     }
// }